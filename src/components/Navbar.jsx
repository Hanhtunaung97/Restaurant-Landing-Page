  ...
  return (
    <header className="bg-black px-5 md:px-10 py-5 shadow">
      <nav className="text-white font-heading flex justify-between items-center text-sm md:text-base select-none">
        ...
        <GiHamburgerMenu className=" w-6 h-6 cursor-pointer text-white" onclick={handleToggleBtn}  />
          ...
          <MdOutlineRestaurantMenu className=" w-6 h-6 cursor-pointer text-golden absolute top-5 right-5" onclick={handleToggleBtn}/>
